...
create sequence AccountSeq
	...
	increment by 1; --moi lan tang 1 don vi
		select next value for AccountSeq
...
begin
	insert into Account
	(
		accountID,email,passwordAcc,roleAcc,username,avartar,createDate,createBy
	)values(
		'ACC' + cast(next value for AccountSeq as char(10)),
		@email,
		@passwordAcc,
		@roleAcc,
		@username,
...
begin
	insert into Film
	(			filmID ,	nameFilm ,	nameEngFilm ,	linkImgAvt ,	linkImgDes,	linkBgImage ,	linkTrailer ,	desText ,
	contentText,	releaseFilm,	statusText ,	releasedEpisodes ,	totalEpisodes ,	imdb ,	quality ,	star ,	nation,	actor ,
	director ,	genre ,	createDate ,	createBy 
	)values(
...
create sequence FilmEpisodeSeq
	start with 1000 --bat dau tu 1000
	increment by 1; --moi lan tang 1 don vi
		select next value for FilmEpisodeSeq
--DROP table Film
...
begin
	...
	(
		...
		'FE' + cast(next value for FilmEpisodeSeq as char(10)),
		@filmID ,	
		@Episode ,
		@linkEpisode 
		);
...
create sequence FeedbackSeq
	start with 1000 --bat dau tu 1000
	increment by 1; --moi lan tang 1 don vi
			select next value for FeedbackSeq
--DROP table Feedback
...
begin
	...
	(
		...
		'FB' + cast(next value for FeedbackSeq as char(10)),
		@filmID ,
		@accountID,
		@cmt ,
		@sentDate 
...
values ('F0001',
		...
		'https://galaphim.net/images/img_thumb/quai-vat-san-dem.small.webp',
		'https://galaphim.net/images/img_thumb/quai-vat-san-dem.small.webp',		
		'<iframe width="560" height="315" src="https://www.youtube.com/embed/Oj63U2RyVvE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
...
insert into Film values ('F0002',
		...
		'https://galaphim.net/images/img_thumb/dang-cap-boss.small.webp',
		'https://galaphim.net/images/img_thumb/dang-cap-boss.small.webp',
		'<iframe width="560" height="315" src="https://www.youtube.com/embed/vcTNydU1T-o" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
...
insert into Film values ('F0003',
		...
		'https://galaphim.net/images/img_thumb/hoc-vien-quai-vat-du-hoc-sinh.small.webp',
		'https://galaphim.net/images/img_thumb/hoc-vien-quai-vat-du-hoc-sinh.small.webp',
		'<iframe width="560" height="315" src="https://www.youtube.com/embed/XKod7ydEhd4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
...
insert into Film values ('F0004',
		...
		'https://img.tvzingvn.net/uploads/2021/04/607077d6acc3992-93583_poster.jpg',
		'https://img.tvzingvn.net/uploads/2021/04/607077d6acc3992-93583_poster.jpg',
				'<iframe width="560" height="315" src="https://www.youtube.com/embed/qnx6-YLXFwg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
...
insert into Film values ('F0005',
		...
		'https://occ-0-1068-1723.1.nflxso.net/dnm/api/v6/E8vDc_W8CLv7-yMQu8KMEC7Rrr8/AAAABYYY14GIxTZLz8PxAh6CehFnSLGLulYYWQ9rt28OK3Ue0byiyCnmaZZxNmseCPKvy39xFjOaVHjyV-NSAsvZdnhC7hD9.jpg?r=78c',
		'https://occ-0-1068-1723.1.nflxso.net/dnm/api/v6/E8vDc_W8CLv7-yMQu8KMEC7Rrr8/AAAABYYY14GIxTZLz8PxAh6CehFnSLGLulYYWQ9rt28OK3Ue0byiyCnmaZZxNmseCPKvy39xFjOaVHjyV-NSAsvZdnhC7hD9.jpg?r=78c',
		'<iframe width="560" height="315" src="https://www.youtube.com/embed/HPJ1-nBhCuY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
...
insert into Film values ('F0006',
		...
		null,
		null,
		'<iframe width="560" height="315" src="https://www.youtube.com/embed/OfWDTj5uLXQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
...
insert into Film values ('F0007',
		...
		null,
		null,
		'<iframe width="560" height="315" src="https://www.youtube.com/embed/L41IJiageyg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
...
insert into Film values ('F0009',
		...
		null,
		null,
		'<iframe width="560" height="315" src="https://www.youtube.com/embed/H5bH6O0bErk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
...
insert into Film values ('F0010',
		...
		null,
		null,
		'<iframe width="560" height="315" src="https://www.youtube.com/embed/_Sm6_FK51VA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
...
insert into Film values ('F0011',
		...
		null,
		null,
		'<iframe width="560" height="315" src="https://www.youtube.com/embed/j-67K-KwHbA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
...
insert into Film values ('F0012',
		...
		null,
		null,
		'<iframe width="560" height="315" src="https://www.youtube.com/embed/oHhiKeyUnnI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
...
insert into Film values ('F0013',
		...
		null,
		null,
		'<iframe width="560" height="315" src="https://www.youtube.com/embed/umtOGzti-XQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
...
insert into Film values ('F0014',
		...
		null,
		null,
		'<iframe width="560" height="315" src="https://www.youtube.com/embed/WZ3dgHqaw8U" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
...
values ('FE0026',
	...
	insert into Film values ('F0015',
		...
		null,
		null,
		'<iframe width="560" height="315" src="https://www.youtube.com/embed/rG6AVqZ52c0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
