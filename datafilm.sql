...
insert into FilmEpisode values ('F0005',
		1,
...
insert into Film values ('F0011',
		...
		'Trong phim ngắn được đề cử giải Oscar này, người đàn ông đang cố về nhà với chú chó của mình thì kẹt trong vòng lặp thời gian của vụ đụng độ chết chóc với một cảnh sát.',
		'Trong phim ngắn được đề cử giải Oscar này, người đàn ông đang cố về nhà với chú chó của mình thì kẹt trong vòng lặp thời gian của vụ đụng độ chết chóc với một cảnh sát.',
		8/1/2020,
		'Đã phát hành',
		1,
...
insert into FilmEpisode values ('F0012',
		1,
...
insert into Film values ('F0013',
		...
		'Sau khi Kaiju tàn phá nước Úc, hai anh em điều khiển một Jaeger để tìm kiếm cha mẹ, đồng thời bắt gặp những sinh vật mới, các nhân vật bất hảo và đồng minh tình cờ.',
		'Sau khi Kaiju tàn phá nước Úc, hai anh em điều khiển một Jaeger để tìm kiếm cha mẹ, đồng thời bắt gặp những sinh vật mới, các nhân vật bất hảo và đồng minh tình cờ.',
		8/11/2021,
		'Đang phát hành',
		4,
...
insert into FilmEpisode values ('F0013',
		1,
...
insert into Film values ('F0014',
		...
		'Cao Bồi Đô Thị - Concrete Cowboy (2020) là bộ phim chính kịch do Ricky Staub đạo diễn, với phần kịch bản được chắp bút bởi Dan Walser và Staub dựa trên tiểu thuyết Ghetto Cowboy của Greg Neri.',
		'Cao Bồi Đô Thị - Concrete Cowboy (2020) là bộ phim chính kịch do Ricky Staub đạo diễn, với phần kịch bản được chắp bút bởi Dan Walser và Staub dựa trên tiểu thuyết Ghetto Cowboy của Greg Neri. Nội dung phim xoay quanh một cậu bé 15 tuổi đến từ Detroit, cậu được gửi đến sống với người cha lạnh nhạt ucar mình ở Philadelphia. Cũng từ đây cậu nhóc nhiệt huyết bắt đầu tìm hiểu về văn hóa cưỡi ngựa và các cao bồi thành thị ở nơi cậu sống.',
		8/11/2021,
		'Đã phát hành',
		1,
		1,
...
values (
	...
	insert into Film values ('F0015',
		...
		'Tham Vọng Thế Giới Ngầm là một bộ phim hành động - tội phạm của Tây Ban Nha, do Daniel Calparsoro đạo diễn',
		'Tham Vọng Thế Giới Ngầm là một bộ phim hành động - tội phạm của Tây Ban Nha, do Daniel Calparsoro đạo diễn. Câu chuyện bắt đầu sau khi người thợ cơ khí ở vùng ngoại ô Madrid Ángel phải lòng Estrella, và lao vào thế giới của những vụ trộm cắp. Đồng thời trở thành mục tiêu truy lùng của một thanh tra thám tử.',
		8/11/2020,
		'Đã phát hành',
		1,
		1,
